...
<div id="login">
    ...
    <div class="wrapper">
        ...
        <div class="login sign-in-htm">
            <form action="/TICKET_war_exploded/login_reg" onSubmit="return login(this);" method="post" class="container offset1 loginform">
                <!-- 猫头鹰控件 -->
        ...
        <div class="login sign-up-htm">
            <form action="/TICKET_war_exploded/login_reg" onSubmit="return register(this)" method="post" class="container offset1 loginform">
                <!-- 猫头鹰控件 -->
