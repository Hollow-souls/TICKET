...
<head>
    <meta charset="UTF-8">
    <title>东风机票预订系统</title>
    <link href="/TICKET_war_exploded/default/css/bootstrap.min.css" rel="stylesheet">
    <link href="/TICKET_war_exploded/default/css/common.css" rel="stylesheet">
    <link href="/TICKET_war_exploded/default/css/corptravel.css" rel="stylesheet">
    <link href="/TICKET_war_exploded/default/css/enterprise.css" rel="stylesheet">
    <link href="/TICKET_war_exploded/default/css/iconfont.css" rel="stylesheet">
    <script type="/TICKET_war_exploded/default/text/javascript" src="js/jquery-1.9.1.min.js"></script>
    <script src="/TICKET_war_exploded/default/js/bootstrap.min.js"></script>
</head>
<body class="bg-body">
<!-- header -->
<nav class="navbar navbar-default navbar-fixed-top bg-white">
    <nav class="navbar navbar-default"
        ...
        <div class="container font12">
            ...
            <ul class="nav navbar-nav nav-top-small" style="margin-left: -15px;">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="/TICKET_war_exploded/default/logout.jsp">退出</a></li>
                    </ul>
                    <%}else{ %>
                    <a href="/TICKET_war_exploded/user_center" class="dropdown-toggle"  role="button" aria-haspopup="true" aria-expanded="false">
                        请登录！
            ...
            <ul class="nav navbar-nav navbar-right nav-top-small">
                <li class="dropdown">
                    <a href="/TICKET_war_exploded/default/message_board.jsp" class="dropdown-toggle"> 留言板 </a>
                </li>
    ...
    <div class="container">
        <div class="navbar-header">
            ...
            <a class=" " href="/TICKET_war_exploded/default/index.jsp"><img src="/TICKET_war_exploded/default/images/logo.png"
        ...
        <div class="collapse navbar-collapse"
            ...
            <ul class="nav navbar-nav navbar-right">
                <li class="active"><a href="/TICKET_war_exploded/default/index.jsp"><i
                        class="icon iconfont icon-nav-block font24">&#xe620;</i> 首页</a></li>
                <li><a href="/TICKET_war_exploded/user_center"><i
...
<div class="index-wall white " style="">
    <div class="container"
        ...
        <form class="form-inline" action="/TICKET_war_exploded/search" method="post">
    ...
    <div class="hangbanlist">
        <div>
            ...
            <ul class="list-inline bor-bottom-solid-1  ">
                <li class="w-percentage-25"><img src="/TICKET_war_exploded/default/images/air/CA.png"
                ...
                <div class="hangbanlist-body " style="background-color: #FEFCFC;">
                    <ul class="list-inline">
                        ...
                        <li class="pull-right "><button type="button"
                                                        ...
                                                        onClick="window.location.href ='/TICKET_war_exploded/default/order.jsp?flight_id=<%=flight_info.getF_n() %>&grade=f';">订票</button></li>
                    </ul>
                    <ul class="list-inline">
                        ...
                        <li class="pull-right "><button type="button"
                                                        class="btn btn-danger btn-sm"
                                                        onClick="window.location.href ='/TICKET_war_exploded/default/order.jsp?flight_id=<%=flight_info.getF_n() %>&grade=b';">订票</button></li>
                    </ul>
                    <ul class="list-inline">
                        ...
                        <li class="pull-right "><button type="button"
                                                        class="btn btn-danger btn-sm"
                                                        onClick="window.location.href ='/TICKET_war_exploded/default/order.jsp?flight_id=<%=flight_info.getF_n() %>&grade=e';">订票</button></li>
                    </ul>
                </div>
            </div>
            <!-- 表BODY 结束 -->
