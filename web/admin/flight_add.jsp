...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/TICKET_war_exploded/admin/asset/css/plugins/animate.min.css"/>
    <link rel="stylesheet" type="text/css" href="/TICKET_war_exploded/admin/asset/css/style.css" >
</head>
<body >
<form method="post" action="/TICKET_war_exploded/add_flight">
